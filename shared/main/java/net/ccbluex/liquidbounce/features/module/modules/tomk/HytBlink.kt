...
@ModuleInfo(name = "HytBlink", description = "Suspends all movement packets.", category = ModuleCategory.TOMK)
class HytBlink : Module() {
        ...
        private val hytnewvalue = BoolValue("HytBlink", false)
        ...
        fun onPacket(event: PacketEvent) {
                ...
                if (hytnewvalue.get()) if (packet is CPacketConfirmTransaction) //CancelC0F
                        event.cancelEvent()
