...
@ModuleInfo(name = "Velocity", description = "fix", category = ModuleCategory.COMBAT)
class Velocity : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("HytBest","HuaYuTingJump","Custom","AAC4","Simple", "SimpleFix","AAC", "AACPush", "AACZero",
