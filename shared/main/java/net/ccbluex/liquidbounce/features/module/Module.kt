        ...
        set(value) {
            ...
            if (!LiquidBounce.isStarting) {
                if(value){
                    ...
                    LiquidBounce.hud.addNotification(Notification("Module toggled", name + " is " +"\u00A7aenabled\r", NotifyType.SUCCESS))
                }else{
                    mc.soundHandler.playSound("random.click", 1F)
                    LiquidBounce.hud.addNotification(Notification("Module toggled",name + " is " +"\u00A7cdisabled\r", NotifyType.ERROR))
                }
            }
