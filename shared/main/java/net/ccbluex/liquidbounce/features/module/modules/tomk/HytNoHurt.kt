...
@ModuleInfo(name = "HytNoHurt", description = "How dare are you", category = ModuleCategory.TOMK)
                ...
                "4v4/1v1", "32/64" -> {
                    ...
                    if (matcher.find()) {
                        ...
                        if (name != "") {
                            ...
                            if (debug.get()) {
                                ClientUtils.displayChatMessage("§f[§6ByteWiz§f]§f§lAdded a bot: " + name)
                            }
                            Thread {
                                try {
                                    Thread.sleep(5000)
                                    ...
                                    if (debug.get()) {
                                        ClientUtils.displayChatMessage("§f[§6ByteWiz§f]§f§lRemoved a bot: " + name)
                                    }
