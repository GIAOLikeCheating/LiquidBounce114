...
class GameFontRenderer(font: Font) : IWrappedFontRenderer {
    ...
    override fun drawString(text: String?, x: Float, y: Float, color: Int, shadow: Boolean): Int {
        ...
        if (shadow) {
            if (CustomFont.shadowValue.get().equals("LiquidBounce")) {
                drawText(currentText, x + 1.0f, currY + 1.0f, Color(0, 0, 0, 150).rgb, true)
            } else if (CustomFont.shadowValue.get().equals("Default")) {
                drawText(currentText, x + 0.5f, currY + 0.5f, Color(0, 0, 0, 130).rgb, true)
            } else if (CustomFont.shadowValue.get().equals( "Custom")) {
                drawText(currentText, x + CustomFont.shadowstrenge.get(), currY + CustomFont.shadowstrenge.get(), Color(20, 20, 20, 200).rgb, true)
            } else if (CustomFont.shadowValue.get().equals("Outline")) {
                drawText(currentText, x + 0.5f, currY + 0.5f, Color(0, 0, 0, 130).rgb, true)
                drawText(currentText, x - 0.5f, currY - 0.5f, Color(0, 0, 0, 130).rgb, true)
                drawText(currentText, x + 0.5f, currY - 0.5f, Color(0, 0, 0, 130).rgb, true)
                drawText(currentText, x - 0.5f, currY + 0.5f, Color(0, 0, 0, 130).rgb, true)
