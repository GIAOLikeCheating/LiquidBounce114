...
class Arraylist(x: Double = 1.0, y: Double = 2.0, scale: Float = 1F,
    ...
    private val colorModeValue = ListValue("Color", arrayOf("Custom", "Random", "Sky", "CRainbow", "LiquidSlowly", "Fade", "DoubleColor", "Gradinet"), "DoubleColor")
    ...
    var fontRenderer = Fonts.tenacitybold35
                ...
                when (vAnimation.get()) {
                    "LiquidSense" -> {
                        ...
                        val color4 = RenderUtils.getGradientOffset(
                                Color(VisualColor.r.get(), VisualColor.b.get(), VisualColor.g.get(), backgroundColorAlphaValue.get()),
                                Color(VisualColor.r2.get(), VisualColor.b2.get(), VisualColor.g2.get(), backgroundColorAlphaValue.get()),
                                (kotlin.math.abs(
            ...
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                                    ...
                                    when (shadowColorMode.get().toLowerCase()) {
                                        ...
                                        "text" -> {
                                            ...
                                            when {
                                                ...
                                                colorMode.equals("Gradinet", true) -> RenderUtils.getGradientOffset(Color(textRed.get(), textGreen.get(), textBlue.get()), Color(textRed2.get(), textGreen2.get(), textBlue2.get()), index * fadeOffset.get().toDouble()).rgb
                                                else -> customColor
                                            }
                                        }
                ...
                modules.forEachIndexed { index, module ->
                    ...
                    fontRenderer.drawString(displayString,
                        ...
                        colorMode.equals("Fade", ignoreCase = true) -> FadeColor
                        colorMode.equals("DoubleColor", ignoreCase = true) -> color4
                        colorMode.equals("Gradinet", true) ->RenderUtils.getGradientOffset(Color(colorRedValue.get(), colorGreenValue.get(), colorBlueValue.get(),1), Color(colorRedValue2.get(), colorGreenValue2.get(), colorBlueValue2.get(),1), (Math.abs(
                    ...
                    if (!rectRightValue.get().equals("none", true)) {
                        val rectColor = when {
                            ...
                            rectColorMode.equals("Gradinet", true) ->RenderUtils.getGradientOffset(Color(colorRedValue.get(), colorGreenValue.get(), colorBlueValue.get(),1), Color(colorRedValue2.get(), colorGreenValue2.get(), colorBlueValue2.get(),1), (Math.abs(
                                    System.currentTimeMillis() / gidentspeed.get()
                                            .toDouble() + (module.higt / fontRenderer.fontHeight)
                            ) / 10)).rgb
